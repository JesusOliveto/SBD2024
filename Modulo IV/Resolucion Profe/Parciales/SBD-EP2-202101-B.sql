-- INGENIERIA EN INFORMATICA - SISTEMAS DE BASES DE DATOS - EVALUACIÓN PARCIAL Nº 2 - TEMA B - 27-05-2021
...
EJERCICIOS:
   a. Ha surgido un nuevo requerimiento en el sistema de gestión de presupuestos: Se requiere un cambio de modelo. En la tabla de 
      movimientos de gastos de presupuestos se debe indicar "obligatoriamente" quien autorizó el movimiento. Y la persona que se 
   ...
   b. Debe migrar los datos actuales. Como la tabla mov_gastos_presupuestos ya tiene filas y no sabemos quien autorizó esos movimientos, 
      se asumirá que los autorizó el responsable del presupuesto. Es decir que para los movimientos ya cargados, se debe registrar al 
	  responsable como la persona que autorizó.
	  Para que esto no produzca un error de clave foránea (porque el responsable no está en la lista de autorizados), agregar al responsable
   ...
   c. Para el área "AREA 20" mostrar los presupuestos (año de presupuesto) que tienen por lo menos alguna cuenta sin movimientos (mov_gastos_presupuestos). (30)
