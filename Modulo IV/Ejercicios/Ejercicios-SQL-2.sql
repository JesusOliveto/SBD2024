...
insert into plan_cuentas
values (2001,'1000000','ACTIVO',				'N',NULL),
...
values (1,'2002-10-02','Depósito en BPC'),
       (2,'2002-12-03','Extracción de BNA'),
       (3,'2002-03-05','Pago a YPF'),
       (4,'2002-10-06','Depósito en BNA'),
       (5,'2002-10-08','Pago a EPEC'),
       (6,'2002-12-08','Transferencia BPC a BNA')
go
...
insert into det_asientos
values (2,1,2000,'1010100',NULL,	'D',700.00),
       (2,2,2000,'1010202',NULL,	'H',700.00)

insert into det_asientos
values (3,1,2000,'2010101',NULL,    'D',600.00),
       (3,2,2000,'1010100',NULL,    'H',200.00),
       (3,3,null,null,     'Cheque','H',300.00)

insert into det_asientos
values (4,1,2000,'1010202',NULL,	'D',400.00),
       (4,2,2000,'1010100',NULL,	'H',400.00)

insert into det_asientos
values (5,1,2000,'2010102',NULL,	'D',1000.00),
       (5,2,2000,'1010100',NULL,	'H',700.00),
       (5,3,2000,'1010201',NULL,	'H',500.00)

insert into det_asientos
values (6,1,2000,'1010202',NULL,	'D',1200.00),
...
- Modificar el script agregando las reglas de integridad indicadas que pueden 
  implementarse en forma declarativa
